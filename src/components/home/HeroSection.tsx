      ...
      <div className="relative z-10 h-full flex items-center">
        <div className="luxe-container">
          <div className="max-w-3xl animate-fade-in">
            <h1 className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl text-white font-medium mb-4">
              Beachfront Plots & Villas | Luxury Resort
            </h1>
            <p className="text-xl md:text-2xl lg:text-3xl text-white font-allura mb-8">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <a 
                ...
                className="btn-outline border-white text-white hover:bg-white hover:text-svn-primary"
              >
                Let's Connect
              </a>
            </div>
